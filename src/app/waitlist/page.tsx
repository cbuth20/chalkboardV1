              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div>
                  ...
                  <select
                    ...
                    required
                    className="w-full px-4 py-3 rounded-lg bg-slate-800/50 border border-slate-700 text-white focus:outline-none focus:border-neon-teal focus:ring-1 focus:ring-neon-teal transition-colors appearance-none cursor-pointer"
